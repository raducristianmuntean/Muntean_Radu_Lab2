...
namespace Muntean_Radu_Lab2.Data
{
    public class Muntean_Radu_Lab2Context : DbContext
    {
        ...
        public DbSet<Muntean_Radu_Lab2.Models.Author> Author { get; set; } = default!;
        ...
        public DbSet<Muntean_Radu_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Muntean_Radu_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
